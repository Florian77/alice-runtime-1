...
const isSubscriptionEmpty = command => R.isEmpty(getSubscription(command));
 ...
 * @return {string}
 */
const stringifyId = (keyOrder, values) => {
 ...
 */
const returnCmdSuccess = (message = [], {subscription = [], warning = false, paused = false} = {}) => ({
    ok: true,
    warning,
 ...
 */
const returnCmdError = (message = [], {subscription = [], paused = false} = {}) => ({
    ok: false,
