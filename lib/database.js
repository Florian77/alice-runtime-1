...
async function getNextStreamSequenceNumber(streamType, streamId) {
...
async function getNextDataStreamSequenceNumber(streamId) {
    return getNextStreamSequenceNumber("DATA", streamId);
}


async function getNextDataIndexSequenceNumber() {
    return getNextStreamSequenceNumber("INDEX", "DATA");
}
