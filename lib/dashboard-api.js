...
const parseTrueFalseString = value => R.equals("true", value) ? true : R.equals("false", value) ? false : value;
const getIndexFilter = param => {
...
const dashboardApi = async (action, param) => {
    ...
    try {
        ...
        // Trigger Index
            ...
            dc.l('isActionTriggerControlOne(action):true', "control", control, "triggerId", triggerId);
        ...
        // Command Control: MANY
            ...
            dc.l('isActionProcessState(action):true');

            dc.t(control, "control")
